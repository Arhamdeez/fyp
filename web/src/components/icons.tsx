...
export function IconCar() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      ...
      <path d="M5 17h-2v-6l2-5h9l2 5v6h-2m-4 0h-4" />
      <path d="M9 17v-5h5v5" />
    </svg>
  );
}
...
export function IconRoute() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      ...
      <path d="M9 19h8.5a2.5 2.5 0 0 0 0-5H9a2.5 2.5 0 0 1 0-5H15" />
